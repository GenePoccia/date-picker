...
class UnconnectedSubmitInformationButton extends Component {
  ...
  handleReserve = () => {
    ...
    .then(responseBody => { 
     ...
     if (body.success) {
           alert('Reserved for ' + body.date + ' with a ' + body.buffer + ' day buffer before and after')
          }
      })
    }
...
let SubmitInformationButton = connect(mapStateToProps)(UnconnectedSubmitInformationButton)
